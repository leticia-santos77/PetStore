        ...
        <div>
            ...
            <nav className="vertical-nav">
                ...
                <ul>
                    ...
                    <li><Link to={{pathname:`/bookingRegistration`}}><p><i className="fas fa-plus"></i>Nova Reserva</p></Link></li>
                    <li><Link to={{pathname:`/resourceRegistration`}}><p><i className="fas fa-folder-plus"></i>Criar Recurso</p></Link></li>
